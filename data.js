...
const quizData = [
  ...
  },
  {
    ...
    },
    {
        ...
        options: [
            "스냅샷은 특정 시점의 블록 스토리지 데이터를 저장한 것이다.",
  ...
  // [영역 1: 클라우드 개념 및 보안 - 9문제 (출제 비율 15%)]
    {
        id: 131,
        question: "클라우드 컴퓨팅의 5가지 핵심 특징 중 사용자가 필요할 때 별도의 관리자 개입 없이 자원을 구성할 수 있는 특성은?",
        options: ["리소스 풀링(Resource Pooling)", "광대역 네트워크 접속", "주문형 셀프 서비스(On-demand Self-service)", "신속한 탄력성"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["멀티 테넌시(Multi-tenancy)", "오픈 소스화", "데이터 가용성", "인프라 추상화"],
        answer: 1,
    ...
    },
    {
        ...
        options: ["IaaS", "PaaS", "서버리스(Serverless)", "On-premise"],
        answer: 2,
    ...
    // [영역 2: NHN Cloud 서비스 특징 - 20문제 (출제 비율 34%)]
    {
        id: 140,
    ...
    },
    {
        ...
        options: ["CloudTrail", "Monitoring", "Log & Crash Search", "Security Advisor"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["인덱싱 정책", "알림 수신 그룹", "스케일링 정책 및 론치 설정", "데이터베이스 복구 시점"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["국가 AI 데이터 센터", "글로벌 허브 센터", "엔터프라이즈 전용 센터", "백업 전용 리전"],
        answer: 1,
    ...
    },
    {
        ...
        options: ["Monitoring", "CloudTrail", "Security Advisor", "App Analytics"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["장기 미사용 할인", "인스턴스 반납 할인", "인스턴스 중지 요금 할인", "결제 수단 할인"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["인스턴스의 운영체제 종류", "인스턴스의 하드웨어 사양(vCPU, Memory)", "인스턴스의 이름", "인스턴스의 보안 등급"],
        answer: 2,
        explanation: "Flavor는 가상 서버의 성능 규격(사양)을 정의하는 용어입니다."
    },

    // [영역 3: NHN Cloud 서비스 활용 기술 - 24문제 (출제 비율 40%)]
    {
        id: 160,
        question: "NHN Cloud 계정 구조에서 자원을 생성하기 위한 프로젝트를 포함하는 최상위 관리 단위는?",
        options: ["리전", "조직(Organization)", "네트워크", "워크스페이스"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["ADMIN", "MEMBER", "OWNER", "VIEWER"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["서버의 이름을 정하기 위해", "IP 주소의 대역폭과 범위를 지정하기 위해", "데이터 암호화 키를 만들기 위해", "사용자 비밀번호를 암호화하기 위해"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["회원 가입을 완료하는 것", "프로젝트 내에서 특정 상품(예: Instance)을 사용할 수 있는 상태로 만드는 것", "인터넷 선을 연결하는 것", "결제를 완료하는 것"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["모든 접속을 차단한다.", "모든 IP 주소로부터의 접속을 허용한다.", "내부 네트워크 접속만 허용한다.", "특정 국가의 접속만 허용한다."],
        answer: 2,
    ...
    },
    {
        ...
        options: ["콘솔에서 즉시 재다운로드한다.", "보안상 재발급이 불가능하므로 새로운 키페어를 사용해 인스턴스를 재생성하거나 복잡한 복구 절차를 거쳐야 한다.", "비밀번호 찾기 기능을 이용한다.", "NHN Cloud 본사를 방문하여 수령한다."],
        answer: 2,
    ...
    },
    {
        ...
        options: ["인터넷 속도를 높이기 위해", "서로 다른 VPC 간에 사설 IP를 통해 안전하게 통신하기 위해", "데이터를 백업하기 위해", "인스턴스 성능을 통합하기 위해"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["이미지", "인스턴스 타입", "블록 스토리지 추가(데이터용)", "네트워크(VPC/Subnet)"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["삭제 잠금", "삭제 보호(Termination Protection)", "데이터 보존 정책", "관리자 잠금"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["ID와 비밀번호", "목적지(Destination)와 타겟(Target/Gateway)", "사용자 이름과 이메일", "이미지 이름과 크기"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["인스턴스가 종료될 때", "인스턴스가 생성된 후 첫 번째 부팅이 완료되었을 때", "매번 재부팅할 때마다", "사용자가 콘솔에 로그인할 때"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["Auto 체크", "헬스 체크(Health Check)", "서버 모니터링", "포트 스캐닝"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["태그(Tag)", "플레이버", "AppKey", "서브넷"],
        answer: 1,
    ...
    },
    {
        ...
        options: ["콘솔의 글자 크기를 바꾸기 위해", "프로그래밍 언어에서 NHN Cloud 서비스를 쉽게 호출하고 개발하기 위해", "컴퓨터의 운영체제를 설치하기 위해", "인터넷 속도를 측정하기 위해"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["성능이 2배로 빨라진다.", "특정 시점의 데이터와 설정 상태를 그대로 복제하여 동일한 환경을 빠르게 구축할 수 있다.", "요금이 전액 면제된다.", "네트워크 설정을 수동으로 하지 않아도 된다."],
        answer: 2,
    ...
    },
    {
        ...
        options: ["라우팅 테이블", "DHCP 옵션 세트", "서브넷 마스크", "보안 그룹"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["30일 이내 복구 가능", "영구 삭제되므로 복구 불가능", "고객 센터를 통해서만 복구 가능", "데이터베이스만 복구 가능"],
        answer: 2,
        explanation: "프로젝트 삭제는 모든 자원의 완전 파괴를 의미하므로 신중해야 합니다."
    },

    // [영역 4: 결제 및 요금 - 7문제 (출제 비율 11%)]
    {
        id: 184,
    ...
    },
    {
        ...
        options: ["인스턴스 설정", "결제 관리", "조직 설정", "고객 지원"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["관리자 징계", "요금 크레딧 보상 신청 및 지급", "서비스 전체 무료 전환", "하드웨어 장비 무상 증정"],
        answer: 2,
